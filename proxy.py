    ...
    def run(self):
        while True:
            ...
            if data:
                ...
                try:
                    reload(parser)                        
                    parser.parse(data, self.port, 'server',scope)
    ...
    def run(self):
        while True:
            ...
            if data:
                ...
                try:
                    reload(parser)        
                    parser.parse(data, self.port, 'client',scope)
                except Exception as e:
...
master_server = Proxy('0.0.0.0', '45.235.98.6', 7903)
master_server.start()
